...
public class ServerStats extends Servlet {
	...
	public void main(HTTPRequest request, HTTPResponse response) {
		...
		doc.write("<p>Received: "
				+ ro.polak.utilities.Utilities
						.fileSizeUnits(ro.polak.webserver.Statistics
								.getBytesReceived()) + "</p>");
		doc.write("<p>Sent: "
				+ ro.polak.utilities.Utilities
						.fileSizeUnits(ro.polak.webserver.Statistics
								.getBytesSend()) + "</p>");
		doc.write("<p>Requests: " + ro.polak.webserver.Statistics.getRequests()
				+ "</p>");
		doc.write("<p>404 errors: "
				+ ro.polak.webserver.Statistics.getError404s() + "</p>");
		doc.write("<p>500 errors: "
				+ ro.polak.webserver.Statistics.getError500s() + "</p>");
