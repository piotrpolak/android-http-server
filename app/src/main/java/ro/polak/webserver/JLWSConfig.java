...
public class JLWSConfig {
	...
	public static boolean initialize() {
		...
		if (config.read(JLWSConfig.basePath + "httpd.conf")) {
			...
			// TODO Mimetype
			JLWSConfig.MimeType = new MimeType(JLWSConfig.basePath
					+ config.get("MimeType"), config.get("DefaultMimeType"));
			...
			JLWSConfig.ErrorDocument404 = JLWSConfig.basePath
					+ config.get("ErrorDocument404");
			JLWSConfig.ErrorDocument403 = JLWSConfig.basePath
					+ config.get("ErrorDocument403");
