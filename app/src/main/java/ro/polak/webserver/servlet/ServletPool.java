...
public class ServletPool {
	...
	public ServletPool() {
		...
		this.pingerTimer.schedule(new RevalidatorTask(this), 1000,
				JLWSConfig.ServletServicePoolPingerInterval);
	}
	...
	protected void revalidate() {
		...
		long expireTimestamp = new Date().getTime()
				- JLWSConfig.ServletServicePoolServletExpires;
